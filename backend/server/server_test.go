...
// testPNG is a 1x1 transparent PNG, small enough to inline and real enough for
// http.ServeContent to sniff a content type from.
var testPNG = []byte{
...
func setupTestServer(t *testing.T) (*Server, string) {
	...
	// images live beside the chapters, which is what /media/ serves
	if err := os.WriteFile(filepath.Join(contentDir, "diagram.png"), testPNG, 0600); err != nil {
